...
function AddRoom() {
  ...
  return (
    <form>
      <Title title='Add Room' align='left' font='outfit' subTitle='Fill in the details carefully and accurate
      ...
      <div className="flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm gap-2">
