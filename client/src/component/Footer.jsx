...
function Footer() {
  return (
    ...
    <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
        ...
        <div>
            <p className='font-open-sans text-lg text-gray-800'>COMPANY</p>
        ...
        <div>
            <p className='font-open-sans text-lg text-gray-800'>SUPPORT</p>
            <ul className='mt-3 flex flex-col gap-2 text-sm'>
        ...
        <div className='max-w-80'>
            <p className='font-open-sans text-lg text-gray-800'>STAY UPDATED</p>
