...
function NewsLetter() {
    return (
        <div className='flex flex-col items-center max-w-5xl rounded-2xl py-12 md:py-16 
          mx-auto my-20 bg-gray-900 text-white sm:px-6 md:px-16 lg:px-24'>

            <Title title='Stay Inspired' subTitle='Join our newsletter and the first to discover new destination , exclusive offers ,and travels inspiration.'/>
